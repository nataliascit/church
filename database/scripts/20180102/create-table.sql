...
CREATE TABLE `PAYMENT-MANAGEMENT`.`CONTRIBUTOR` (
  ...
  CIVIL_STATE CHAR(2) NOT NULL COMMENT 'THE CIVIL STATE OF THE CONTRIBUTOR. THE POSSIBLE VALUES ARE: SINGLE, MARRIED, STABLE UNION, DIVORCED AND WIDOWER.',
  ...
  INSERT_DATE DATE NOT NULL COMMENT 'THE DAT THAT THE CONTRIBUTOR WAS REGISTERED'
