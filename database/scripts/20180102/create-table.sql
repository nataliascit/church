...
CREATE TABLE `PAYMENT-MANAGEMENT`.`CHURCH` (
  ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'SEQUENTIAL IDENTIFIER OF CHURCH.',
...
CREATE TABLE `PAYMENT-MANAGEMENT`.`CAMPAIGN` (
  ...
  ID_CHURCH BIGINT NULL COMMENT 'SEQUENTIAL IDENTIFIER OF CHURCH.',
...
CREATE TABLE `PAYMENT-MANAGEMENT`.`CONTRIBUTOR` (
  ...
  GENDER CHAR(1) NOT NULL COMMENT 'THE GENDER OF THE CONTRIBUTOR, WHERE M - MALE AND F - FEMALE.',
  CIVIL_STATE VARCHAR(50) NOT NULL COMMENT 'THE CIVIL STATE OF THE CONTRIBUTOR. THE POSSIBLE VALUES ARE: SINGLE, MARRIAGE, STABLE UNION, DIVORCED AND WIDOWER.',
